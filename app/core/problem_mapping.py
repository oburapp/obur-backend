...
DOMAIN_PROBLEMS: dict[type[Exception], Problem] = {
    ...
    BlockNotFoundError: problems.RELATIONSHIP_NOT_FOUND,
    SelfBlockError: problems.SELF_BLOCK,
    MuteNotFoundError: problems.RELATIONSHIP_NOT_FOUND,
    SelfMuteError: problems.SELF_MUTE,
    # Reporting
    ContentReportNotFoundError: problems.CONTENT_REPORT_NOT_FOUND,
    VenueReportNotFoundError: problems.VENUE_REPORT_NOT_FOUND,
    # Account
    ...
    UserNotFoundError: problems.USER_NOT_FOUND,
    # Auth
