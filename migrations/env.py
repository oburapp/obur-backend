"""Alembic environment: wires migrations to the app's models and DB URL."""
...
# Schemas belonging to PostGIS extensions we don't install (see
...
def get_url() -> str:
    """Resolve the database URL from app settings, not from alembic.ini."""
